...
<body>
    ...
    <div class="options">
        ...
        <?php if ($loggedInUser != "None"){echo 'Welcome, <a href="profile?' . $loggedInUser . '">' .$loggedInUser. '</a>';} ?>
    ...
    <div class="feed">
        ...
        for ($x = 1; $x < $posts_count + 1; $x++){
            ...
            echo nl2br(
                "<font color='#0080ff'><b>" . $posts_array_row[2]. "</b></font> <font color='gray' size='2'>" . date_format($posts_array_row[3], "m/d/Y h:ia") . "</font>\n" .
                $posts_array_row[1]."\n\n"
            );
