        ...
        <span class="wall" id="wall">
            ...
            if ($selectedUserID == $currentUserID || in_array($selectedUserID, $currentUserFriendsArray)){
                ...
                echo        "<font color='gray' size='2'>" . date_format($posts_array_row[3], "m/d/Y h:ia") . "</font><br>";
                            ...
                            //Like/unlike button
                            if (!in_array($loggedInUser, $likesArray)){echo "<a href='?selectedUser=" . $selectedUser . "&likePost=" . $posts_array_row[0] . "&author=" . $posts_array_row[2] . "&page=" . $page_number . "#" . $anchor . "'>Like</a>&nbsp";}
